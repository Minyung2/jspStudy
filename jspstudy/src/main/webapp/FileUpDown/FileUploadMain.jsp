...
<body>
	...
	action="UploadPrc.jsp" onsubmit="return validationForm(this);">
		...
		카테고리:<input type="checkbox" name="cate" value="사진" checked/> 사진
		카테고리:<input type="checkbox" name="cate" value="문서" checked/> 문서
		카테고리:<input type="checkbox" name="cate" value="음악" checked/> 음악<br>
